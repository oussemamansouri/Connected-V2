...
@Component({
  selector: 'app-centre-layoute',
  templateUrl: './centre-layoute.component.html',
  styleUrls: ['./centre-layoute.component.scss']
})
...
this.api.getcentre(decodedtoken.id).subscribe(data=>this.data=data)
  }
